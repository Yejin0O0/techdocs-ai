...
- [x] 업로드 진행률 바
- [x] 파일 목록 UI — 상태 뱃지: 인덱싱 중 / 준비 완료 / 오류
- [x] 파일 삭제 기능
- [x] 중복 파일명 업로드 시 경고 UI
- [x] 백엔드 `/upload`, `/docs`, `/docs/status` SSE, `/docs/:id` DELETE 연결
...
- [x] 출처 뱃지 컴포넌트 (`SourceBadge.tsx`)
- [x] 원문 하이라이트 사이드패널 (`SourcePanel.tsx`)
- [x] 뱃지 클릭 → 사이드패널 오픈 연결

### Day 6 (토) — UX 디테일 `4h`

- [x] Skeleton 로딩 / 에러 상태 / 빈 상태 UI
- [x] 다크모드 + 반응형 레이아웃
